...
jQuery(function($){
  var slider = $('.slider-window:not(.unslider-horizontal)').unslider({
    delay: 10000,
    dots: true,
    nav: true,
    autoplay: true,
    ...
    arrows: {
      prev: '<a class="unslider-arrow prev"><strong><</strong></a>',
      next: '<a class="unslider-arrow next"><strong>></strong></a>'
    },
  });

  $(window).bind("resize load", function(){
    if($('#mobile-nav').is(':visible')){
      $('.slide__text h3.text-white p:has(a)').show();
    }

  });

  var events_slider = $('.events-slider-view .view-content:not(.unslider-horizontal)').unslider({
    delay: 3000,
    dots: false,
    nav: false,
    autoplay: true,
  ...
  $('.view-tweets span.field-content a:not(.twitter-timeline-link)')
    .attr('target','_blank')
    .attr('rel','nofollow');
});
;

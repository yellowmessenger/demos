var toutLibrary = {
	...
	setup : function(dfltChannel, adVars, channels) {
		...
		if (/internal-cmbuild-e-cmtoolsc-1mr40kmcev02k-1571513711\.us-east-1\.elb\.amazonaws\.com/.test(window.location.href)){
			this.resources_path = this.resources_path.replace('//subscription-assets.timeinc.com/prod/assets/themes/magazines/', '//internal-cmbuild-e-cmtoolsc-1mr40kmcev02k-1571513711\.us-east-1\.elb\.amazonaws\.com/themes/magazines/');

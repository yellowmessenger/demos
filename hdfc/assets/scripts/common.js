...
$(document).ready(function () {
	...
	if (scroll >= 33) {
		...
		$(".mainBodyContainer").css("padding-top", 28);
		$(".finances_inner_content_wrapper").css("padding-top", 0);
    } else {
        $(".topnav_wrapper").show();
		$(".headerWrapper").removeClass("stick")
		$(".mainBodyContainer").css("padding-top", 0);
...
$('#slidingbannersbuttons').append('<a class="" href="#"><span style="display: block;">1</span></a><a class="selected" href="#"><span>2</span></a><a class="" href="#"><span>3</span></a><a class="" href="#"><span>4</span></a>');
...
$('.mainBodyContainer #overlay').css('height' , $(document).height())
	...
	$(".loginboxlinks").after("<div class='errorloginmsg'>Please select any one option.</div>")
	}
	});

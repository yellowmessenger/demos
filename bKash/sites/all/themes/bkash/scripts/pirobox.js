	...
	$.fn.piroBox = function(opt) {
		...
		function start_pirobox() {
		  var corners = 
			...
			var caption = $(jQuery('<div class="piro-caption"></div>'));
			...
			var imgCache = $(my_gall_classes).each(function(){href='+ this_url +'});
			...
			$(piro_gallery).each(function(array) {
				...
				img.onload = function() {
					...
					$(img).height(imgH).width(imgW).hide();
						...
						$('.piro_nav,.piro-caption').css({width:(imgW)+'px','margin-bottom':'10px'});

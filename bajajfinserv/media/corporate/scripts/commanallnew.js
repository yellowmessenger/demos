...
(function() {
    try {
        setTimeout(function() {
            ...
            var listofmenu = document.querySelectorAll("ul.nav.nav-centre.navbar-nav.desk a");
            for (var i = 0; i < listofmenu.length; i++) {
                if ((!listofmenu[i].href.includes("javascript") && !listofmenu[i].href === undefined) || listofmenu[i].href.includes("http") || listofmenu[i].href.includes("asp")) {
                    listofmenu[i].onclick = function() { subNavigationDL(this); return true; }
                }
            }
            ...
            var sidebarProduct = document.querySelectorAll(".sidebar-nav li a");
            ...
            var productDetailsButton = document.querySelectorAll("#tab_1 a");
            ...
            var applyNowButtonProduct = document.querySelectorAll("#sectionA > ul > li > a");
            if (applyNowButtonProduct.length > 0) {
                for (var i = 0; i < applyNowButtonProduct.length; i++) {
                    applyNowButtonProduct[i].onclick = function() {
            ...
            //CC pages
            var ccQuickLinks = document.querySelectorAll(".quick-link .quick-menu a");
            ...
            var quickLinkCC = document.querySelectorAll(".fee-outer  a");

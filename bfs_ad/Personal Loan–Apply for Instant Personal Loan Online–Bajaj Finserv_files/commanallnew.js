...
function hpBannerDL(a) {
    ...
    if (bannerTitleElm.length > 0) {
        ...
        if (banc.length > 0) {
            ...
            if (pageType.toLowerCase() == 'finance') {
                bannerText = "EMI Network - the way to pay";
            }
        }
    }

    var elementText = a.innerText;
    var elementSibText = a.parentNode.querySelector('.topcapbtn');
    if (elementText.length <= 1) {
        if (elementSibText == null) {
            elementSibText = "Banner Clicked";
        } else {
            elementSibText = elementSibText.innerText;
        }
        elementText = elementSibText;
    }
...
function hpmBannerDL(a) {
    ...
    var elementText = a.innerText;
    if (elementText === "") {
        elementText = "Banner Clicked";
    }

    if (pageType.toLowerCase() == "investment" || pageType.toLowerCase() == "finance") {
        if (a.parentNode.getAttribute('class') != 'top-bnr') {
            ...
            dataLayer.push({
                ...
                'element': elementText.toLowerCase(),
                'bannernumber': 1,
                'activebannertext': 'emi network - the way to pay'
            });
        }
    }
...
function getBannerPos(a) {
    ...
    if (pageType == "Finance") {
        ...
        incrementby = (getElementIndex(child.parentNode.parentNode.parentNode) === 1) ? 0 : 4;
    }
    ...
    if (onpProductClick.length > 0) {
        for (var i = 0; i < onpProductClick.length; i++) {
            onpProductClick[i].onclick = function() {
                ...
                var elementText = "";
                var prName = this.parentNode.parentNode;
                elementText += prName.querySelector('.spInfo > p').innerText + " | ";
                elementText += getParameterByName("ID", this.href);
...
(function() {
    try {
        setTimeout(function() {
            ...
            // Product Page
            var submitButtonProduct = document.querySelectorAll('.Submit');
            if (submitButtonProduct.length > 0) {
                for (var i = 0; i < submitButtonProduct.length; i++) {
                    submitButtonProduct[i].addEventListener("click", function() {
            ...
            var productDetailsButton = document.querySelectorAll("#tab_1 a,#tab_2 a,#tab_3 a,#tab_4 a,#collapseOne a,#collapseTwo a,#collapseThree a,#collapseFour a,#collapse1 a,#collapse2 a,#collapse3 a,#collapse4 a,#term_con > div > table a");
            if (productDetailsButton.length > 0) {
                for (var i = 0; i < productDetailsButton.length; i++) {
                    ...
                    productDetailsButton[i].onclick = function() {
                        var elementTextStr = "";
                        if (this.innerText == "") {
                            elementTextStr += getBreadCrum() + this.parentNode.parentNode.querySelectorAll('td')[1].innerText;
                        } else {
                            elementTextStr += getBreadCrum() + this.innerText;
                        }
                        dataLayer.push({
            ...
            var applyNowButtonProduct = document.querySelectorAll("#image-Carousel div.apply-btn > a,#myCarousel div img,#myCarousel div a.btn");
            ...
            // HL Landing Page
            var hlctaButton = document.querySelectorAll("#container div.toBegain > a");
            ...
            var hlmctaButton = document.querySelectorAll("#mainContainer .btnContainer > a");
            if (hlmctaButton.length > 0) {
                for (var i = 0; i < hlmctaButton.length; i++) {
                    hlmctaButton[i].onclick = function() {
            ...
            var hlpdButton = document.querySelectorAll("#container div.borderTop a,#accordion .panel > a");
            ...
            var hlpdCtaButton = document.querySelectorAll("div.PopDetails a,#collapse1 .btnContainer > a,#collapse2 .btnContainer > a,#collapse3 .btnContainer > a");
            ...
            var hlpdmCtaButton = document.querySelectorAll("#collapse1 .btnContainer > a,#collapse2 .btnContainer > a,#collapse3 .btnContainer > a");
            if (hlpdmCtaButton.length > 0) {
                for (var i = 0; i < hlpdmCtaButton.length; i++) {
                    hlpdmCtaButton[i].onclick = function() {
            ...
            if (pageType === "Lead Form") {
                ...
                if (submitButtonBL.length > 0) {
                    for (var i = 0; i < submitButtonBL.length; i++) {
                        submitButtonBL[i].addEventListener("click", function() {
                            var loanName = "";
                            ...
                            var stepNumber = "";
                            if (this.getAttribute('class').match('stepbizFpt2')) {
                                stepNumber = "step - 1";
                            } else if (this.getAttribute('class').match('stepbizFpt3')) {
                                stepNumber = "step - 2";
                            } else if (this.getAttribute('class').match('step3submitbtn')) {
                                stepNumber = "step - 3";
                            }

                            dataLayer.push({
                                'event': 'lead_form_submit_Loan_LeadForm_1',
                                'stepnumber': stepNumber.toLowerCase(),
                                'pageType': pageType.toLowerCase(),

...
function za(a){if(!Aa.test(a))return a;-1!=a.indexOf("&")&&(a=a.replace(Ba,"&amp;"));-1!=a.indexOf("<")&&(a=a.replace(Ca,"&lt;"));-1!=a.indexOf(">")&&(a=a.replace(Da,"&gt;"));-1!=a.indexOf('"')&&(a=a.replace(Ga,"&quot;"));-1!=a.indexOf("'")&&(a=a.replace(Ha,"&#39;"));-1!=a.indexOf("\x00")&&(a=a.replace(Ia,"&#0;"));return a}
var Ba=/&/g,Ca=/</g,Da=/>/g,Ga=/"/g,Ha=/'/g,Ia=/\x00/g,Aa=/[\x00&<>"']/;function Ja(a,b){return a<b?-1:a>b?1:0}
function Ka(a){for(var b=0,c=0;c<a.length;++c)b=31*b+a.charCodeAt(c)>>>0;return b}
;var La=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if(r(a))return r(b)&&1==b.length?a.indexOf(b,0):-1;
...
gd.prototype.g=function(a){var b=gd.o.g.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<z()||c&&c>z())gd.prototype.remove.call(this,a);else return b}};function hd(a){this.b=a}
A(hd,gd);function id(){}
;function jd(){}
...
;function Sg(a,b){I.call(this);this.m=this.R=a;this.I=b;this.u=!1;this.f={};this.O=this.H=null;this.A=new K;mc(this,y(nc,this.A));this.i={};this.M=this.P=this.h=this.Z=this.b=null;this.L=!1;this.j=this.F=null;this.S={};this.qa=["onReady"];this.Y=null;this.ga=NaN;this.N={};Tg(this);this.U("WATCH_LATER_VIDEO_ADDED",x(this.Fa,this));this.U("WATCH_LATER_VIDEO_REMOVED",x(this.Ga,this));this.U("onAdAnnounce",x(this.ta,this));this.ra=new Tf(this);mc(this,y(nc,this.ra))}
...
zh.prototype.l=function(){ef(this.i);this.b=null;zh.o.l.call(this)};function Ah(){var a=Bh()?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=ab(Ch);return new J(function(c,d){b.C=function(a){ve(a)?c(a):d(new Dh("Request failed, status="+a.status,"net.badstatus",a))};
b.onError=function(a){d(new Dh("Unknown request error","net.unknown",a))};
b.K=function(a){d(new Dh("Request timed out","net.timeout",a))};
De(a,b)})}
...
(u||window).document,Ed="CSS1Compat"==Ea.compatMode?Ea.documentElement:Ea.body;X=(new Gb(Ed.clientWidth,Ed.clientHeight)).round()}var Fa=X}catch(kb){Fa=new Gb(-12245933,-12245933)}X={};Ea=0;p.SVGElement&&p.document.createElementNS&&(Ea|=1);X.bc=Ea;X.bih=Fa.height;X.biw=Fa.width;X.brdim=m.join();Fa=(X.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Pb.webkitVisibilityState||Pb.mozVisibilityState||Pb.visibilityState||""]||0,X.wgl=!!H.WebGLRenderingContext,X);for(var Fd in Fa)d[Fd]=Fa[Fd]}void 0!==
...
function ei(a){var b=sf();a=$h[a.id];b&&a&&(T("interaction_click_on_gel_web")?If("visualElementGestured",{csn:b,ve:kf(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},Kf):Mf(Kf,{click:{csn:b,visualElement:kf(a)}}))}

...
let Request = {
    AUTH_API: {
        ...
        form: {
            ...
            client_id: '781e6cfd-b794-48d3-96bf-8fe742b838ee',
            client_secret: '5WMJ0s4P+7/k6urqMk5bIiFCY5OwwU8DoiJSc3QRgX4='
        },
        json: true
    },
    ...
    encrypt(plainText) {
        ...
        let keyBase64 = "XFRSDEHUTFKUQOPI";
        const key = Buffer.from(keyBase64, 'utf-8');
        const cipher = crypto.createCipheriv(Request.getAlgorithm(keyBase64), key, '');
